...
Scaleway is the only cloud provider to offer three different ecosystems of products and services, for a wide range of hosting and cloud needs. **Scaleway Datacenter** is our private data center colocation solution, **Scaleway Dedibox** offers you dedicated servers for maximum control, while **Scaleway Elements** provides a comprehensive ecosystem of Instances and cloud products.
<Steps>
...
[Scaleway Quickstart Guide](scaleway-quickstart-1.4.pdf)
