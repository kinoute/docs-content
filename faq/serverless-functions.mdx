...
Serverless Functions enables you to deploy functions developed using the following languages:
 * NodeJS 14, 16, NodeJS 18 is currently in Beta
 * Python 3.7, 3.8, 3.9 and 3.10
 * Go 1.13, 1.17, 1.18

Refer to our dedicated page about [Serverless Functions Runtimes Lifecycle](/compute/functions/reference-content/functions-lifecycle)
