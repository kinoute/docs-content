...
* [Scaleway IoT Hub Overview](/iot/iot-hub/quickstart/)
* [Hub](/iot/iot-hub/concepts/#hub)
* [Device](/iot/iot-hub/concepts/#device)
* [Route](/iot/iot-hub/concepts/#routes)
...
Each IoT Hub can be fully configured both from the management console, and a powerful [REST-API](https://developers.scaleway.com/en/products/iot/api/).
...
## Why don't I receive any messages when subscribing to $SYS on "shared" Hubs?
