...
<Lightbox src={["assets/scaleway-caas-billing-1.webp","assets/scaleway-caas-billing-2.webp"]} size={"medium"}  alt={["Scerverless Containers Billing","Serverless Containers Billing"]} />
...
| Amount of vCPU allocated (for now automatic depending on the tier used) 	| 70 mCPU      	|
| Free Tiers                                                               	| Yes          	|
...
* **vCPU consumption**
    * *Allocated vCPU conversion:* 70mCPU = 0.070 vCPU
...
Refer to our dedicated page about [Serverless Containers limitations and configuration restrictions](/compute/containers/reference-content/containers-limitations/) for more information.